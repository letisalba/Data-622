...
wine_df2_split <- initial_split(wine_df2, prop = 0.75)
wine_train <- training(wine_df2_split)
wine_test <- testing(wine_df2_split)
...
wine_model <- rpart(Quality ~ ., method = "class", data = wine_train)
