...
The accuracy of the SVM is 63.7% for the original data set:
```{r, echo=FALSE}
# Extract accuracy from the confusion matrix
...
The accuracy of the SVM is 60.5% for the original data set which is lower than the first SVM accuracy:
```{r, echo=FALSE}
# Extract accuracy from the confusion matrix
